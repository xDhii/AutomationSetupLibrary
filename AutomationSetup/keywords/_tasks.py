...
class _Tasks(KeywordGroup):
    ...
    def robot_options(self, value):
        ...
        if (value == "default"):
            ...
            r = options["default"]["robot_options"] + python_path + options[value]["robot_options"]
    ...
    def rebot_options(self, value):
        ...
        if (value == "default"):
            ...
            r = options["default"]["rebot_options"] + options[value]["rebot_options"]
